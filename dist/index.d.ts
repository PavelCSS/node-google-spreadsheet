 ...
 */
type IterativeCalculationSetting = {
...
type WorksheetPropertiesPartial = {};
...
type DimensionRangeWithoutWorksheetId = Omit<DimensionRange, 'sheetId'>;
/**
...
declare function columnToLetter(column: number): string;
declare function letterToColumn(letter: string): number;
declare function axiosParamsSerializer(params: Record<PropertyKey, any>): string;
declare function checkForDuplicateHeaders(headers: string[]): void;
declare const parseRangeA1: (a1Address: A1Range) => {
    rangeA1: string;
...
declare class GoogleSpreadsheetWorksheet {
    ...
    getCellsByA1Range(a1Range: A1Range, flip?: boolean): GoogleSpreadsheetCell[][];
    getCells({ startRowIndex, startColumnIndex, endRowIndex, endColumnIndex, }: GridRangeWithoutWorksheetId, flip?: boolean): GoogleSpreadsheetCell[][];
